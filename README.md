...
<hr>
<p> This application was created using <strong>Redux-Saga</strong> middleware. It displays data from <em>algolia.com </em> API, has a pagination for each "news" page and also has a Login/Sign-up forms with validation rules that were created using <strong>>Formik</strong library<br><br>
...
<hr>
<img alt='Fourth screenshot' src='/screenshots/4.jpg' >
<hr>
<img alt='Fifth screenshot' src='/screenshots/5.jpg' >
